...
function Badge({ position, strategy, index, radius, speed, offset, isInView, prefersReducedMotion, borderColor }: BadgeProps) {
  ...
  return (
    <group ref={meshRef} position={position}>
      ...
      >
        <motion.div
          className="px-2 py-1 rounded-full border cursor-pointer bg-black/60 backdrop-blur-sm"
          style={{
        ...
        >
          <motion.span
            className="text-xs font-medium text-white-900 whitespace-nowrap"
            animate={{
...
export function MobileEarlyAccessSection() {
  ...
  return (
    <section
      ref={sectionRef}
      className="bg-surface-900 relative overflow-hidden flex items-center justify-center px-4 py-20 min-h-screen"
    >
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="flex flex-col items-center justify-center text-center space-y-6">
          ...
          <motion.h2
            ...
            className="text-2xl text-white-900 leading-tight tracking-tight"
          >
            Early access open
          </motion.h2>
          ...
          <motion.p
            ...
            className="text-sm text-white-700 max-w-sm mx-auto"
          >
              ...
              return (
                ...
                >
                  <motion.div
                    ...
                    transition={{ duration: 0.3, delay: isInView ? 0.6 + idx * 0.05 : 0 }}
